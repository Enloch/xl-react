...
const useModeloStore = create((set) => ({
  ...
  camara: false,
  pdfdownload: "downloads/fichasmesa/kir.pdf",
  zipdownload: "downloads/modelos/KIR.zip",
  setZipDownload: (zip) => set({ zipdownload: zip }),
  setPdfDownload: (pdf) => set({ pdfdownload: pdf }),
