      ...
      <DivisorBottom>
        <ContenidoBottom>
          <ContenedorSlider>
            <ContenedorInterior>
              <Slider>
                <CustomSliderMesas images={ZamaData.imagenes} />
              </Slider>
            </ContenedorInterior>
          </ContenedorSlider>
          <ContenedorDatos>
            <ContenedorInterior>
              <TituloMesa>{ZamaData.titulo}</TituloMesa>
              <SubtituloConPunto>
                <Punto>
                  <svg
                    width='12'
                ...
                <ContenedorTextoPunto>
                  <TextoPunto>{ZamaData.subtitulo}</TextoPunto>
                </ContenedorTextoPunto>
              </SubtituloConPunto>
              <ParrafoSubtitulo>
                {ZamaData.parrafo1}
                    ...
                    {ZamaData.fijo && (
                      <Accordion allowToggle>
                        <AccordionItem border='0px'>
                          ...
                          {renderAccordionPanel(ZamaData.tamanosFijo, 4)}
                        </AccordionItem>
                      </Accordion>
                    )}
                    {ZamaData.extensible && (
                      <Accordion allowToggle>
                        <AccordionItem border='0px'>
                          ...
                          {renderAccordionPanel(
                            ZamaData.tamanosExtensibles,
                            11
                          )}
                        </AccordionItem>
                      </Accordion>
                    )}
                    {ZamaData.fijocircular && (
                      <Accordion allowToggle>
                        <AccordionItem border='0px'>
                          <AccordionButton>
                            <Box flex='1' textAlign='left'>
                          ...
                          {renderAccordionPanel(ZamaData.tamanosCirculo, 4)}
                        </AccordionItem>
                      </Accordion>
                    )}
                    {ZamaData.extensiblecircular && (
                      <Accordion allowToggle>
                        <AccordionItem border='0px'>
                          <AccordionButton>
                            <Box flex='1' textAlign='left'>
                          ...
                          {renderAccordionPanel(ZamaData.tamanosCircularExt, 4)}
                        </AccordionItem>
                      </Accordion>
                    )}
                  </AccordionPanel>
