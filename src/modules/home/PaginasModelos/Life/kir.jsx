      ...
      <DivisorBottom>
        <ContenidoBottom>
          <ContenedorSlider>
            <ContenedorInterior>
              <Slider>
                <CustomSliderMesas images={KirData.imagenes} />
              </Slider>
            </ContenedorInterior>
          </ContenedorSlider>
          <ContenedorDatos>
            <ContenedorInterior>
              <TituloMesa>{KirData.titulo}</TituloMesa>
              <SubtituloConPunto>
                <Punto>
                  <svg
                    width='12'
                ...
                <ContenedorTextoPunto>
                  <TextoPunto>{KirData.subtitulo}</TextoPunto>
                </ContenedorTextoPunto>
              </SubtituloConPunto>
              <ParrafoSubtitulo>
                {KirData.parrafo1}
                    ...
                    {KirData.fijo && (
                      <Accordion allowToggle>
                        <AccordionItem border='0px'>
                          ...
                          {renderAccordionPanel(KirData.tamanosFijo, 4)}
                        </AccordionItem>
                      </Accordion>
                    )}
                    {KirData.extensible && (
                      <Accordion allowToggle>
                        <AccordionItem border='0px'>
                          ...
                          {renderAccordionPanel(KirData.tamanosExtensibles, 6)}
                        </AccordionItem>
                      </Accordion>
                    )}
                    {KirData.fijocircular && (
                      <Accordion allowToggle>
                        <AccordionItem border='0px'>
                          <AccordionButton>
                            <Box flex='1' textAlign='left'>
                          ...
                          {renderAccordionPanel(KirData.tamanosCirculo, 4)}
                        </AccordionItem>
                      </Accordion>
                    )}
                    {KirData.extensiblecircular && (
                      <Accordion allowToggle>
                        <AccordionItem border='0px'>
                          <AccordionButton>
                            <Box flex='1' textAlign='left'>
                          ...
                          {renderAccordionPanel(KirData.tamanosCircularExt, 4)}
                        </AccordionItem>
                      </Accordion>
                    )}
                  </AccordionPanel>
