      ...
      <DivisorBottom>
        <ContenidoBottom>
          <ContenedorSlider>
            <ContenedorInterior>
              <Slider>
                <CustomSliderMesas images={CollinsData.imagenes} />
              </Slider>
            </ContenedorInterior>
          </ContenedorSlider>
          <ContenedorDatos>
            <ContenedorInterior>
              <TituloMesa>{CollinsData.titulo}</TituloMesa>
              <SubtituloConPunto>
                <Punto>
                  <svg
                    width='12'
                ...
                <ContenedorTextoPunto>
                  <TextoPunto>{CollinsData.subtitulo}</TextoPunto>
                </ContenedorTextoPunto>
              </SubtituloConPunto>
              <ParrafoSubtitulo>
                {CollinsData.parrafo1}
                <br />
                {CollinsData.parrafo2}
                <br />
                {CollinsData.parrafo3}
                <br />
                {CollinsData.parrafo4}
              </ParrafoSubtitulo>
                    ...
                    {CollinsData.fijo && (
                      <Accordion allowToggle defaultIndex={[0]}>
                        <AccordionItem border='0px'>
                          ...
                          {renderAccordionPanel(CollinsData.tamanosFijo, 4)}
                        </AccordionItem>
                      </Accordion>
                    )}
                    {CollinsData.extensible && (
                      <Accordion allowToggle defaultIndex={[0]}>
                        <AccordionItem border='0px'>
                          <AccordionButton>
                            <Box flex='1' textAlign='left'>
                          ...
                          {renderAccordionPanel(
                            CollinsData.tamanosExtensibles,
                            4
                          )}
                        </AccordionItem>
                      </Accordion>
                    )}
                    {CollinsData.fijocircular && (
                      <Accordion allowToggle>
                        <AccordionItem border='0px'>
                          <AccordionButton>
                            <Box flex='1' textAlign='left'>
