...
import { HemingwayData } from "../data";
import {
  Accordion,
  AccordionItem,
  AccordionButton,
      ...
      <DivisorBottom>
        <ContenidoBottom>
          <ContenedorSlider>
            <ContenedorInterior>
              <Slider>
                <CustomSliderMesas images={HemingwayData.imagenes} />
              </Slider>
            </ContenedorInterior>
          </ContenedorSlider>
          <ContenedorDatos>
            <ContenedorInterior>
              <TituloMesa>{HemingwayData.titulo}</TituloMesa>
              <SubtituloConPunto>
                <Punto>
                  <svg
                    width='12'
                ...
                <ContenedorTextoPunto>
                  <TextoPunto>{HemingwayData.subtitulo}</TextoPunto>
                </ContenedorTextoPunto>
              </SubtituloConPunto>
              <ParrafoSubtitulo>
                {HemingwayData.parrafo1}
                <br />
                {HemingwayData.parrafo2}
                <br />
                {HemingwayData.parrafo3}
                <br />
                {HemingwayData.parrafo4}
              </ParrafoSubtitulo>
                    ...
                    {HemingwayData.fijo && (
                      <Accordion allowToggle>
                        <AccordionItem border='0px'>
                          ...
                          {renderAccordionPanel(HemingwayData.tamanosFijo, 4)}
                        </AccordionItem>
                      </Accordion>
                    )}
                    {HemingwayData.extensible && (
                      <Accordion allowToggle>
                        <AccordionItem border='0px'>
                          <AccordionButton>
                            <Box flex='1' textAlign='left'>
                          ...
                          {renderAccordionPanel(
                            HemingwayData.tamanosExtensibles,
                            6
                          )}
                        </AccordionItem>
                      </Accordion>
                    )}
                    {HemingwayData.fijocircular && (
                      <Accordion allowToggle>
                        <AccordionItem border='0px'>
                          <AccordionButton>
                            <Box flex='1' textAlign='left'>
                          ...
                          {renderAccordionPanel(
                            HemingwayData.tamanosCirculo,
                            4
                          )}
                        </AccordionItem>
                      </Accordion>
                    )}
                    {HemingwayData.extensiblecircular && (
                      <Accordion allowToggle>
                        <AccordionItem border='0px'>
                          <AccordionButton>
                            <Box flex='1' textAlign='left'>
                          ...
                          {renderAccordionPanel(
                            HemingwayData.tamanosCircularExt,
                            4
                          )}
                        </AccordionItem>
                      </Accordion>
