      ...
      <DivisorBottom>
        <ContenidoBottom>
          <ContenedorSlider>
            <ContenedorInterior>
              <Slider>
                <CustomSliderMesas images={ProgettoData.imagenes} />
              </Slider>
            </ContenedorInterior>
          </ContenedorSlider>
          <ContenedorDatos>
            <ContenedorInterior>
              <TituloMesa>{ProgettoData.titulo}</TituloMesa>
              <SubtituloConPunto>
                <Punto>
                  <svg
                    width='12'
                ...
                <ContenedorTextoPunto>
                  <TextoPunto>{ProgettoData.subtitulo}</TextoPunto>
                </ContenedorTextoPunto>
              </SubtituloConPunto>
              <ParrafoSubtitulo>
                {ProgettoData.parrafo1}
                <br />
                {ProgettoData.parrafo2}
                <br />
                {ProgettoData.parrafo3}
                <br />
                {ProgettoData.parrafo4}
              </ParrafoSubtitulo>
                    ...
                    {ProgettoData.fijo && (
                      <Accordion allowToggle defaultIndex={[0]}>
                        <AccordionItem border='0px'>
                          ...
                          <AccordionPanel>
                            {ProgettoData.tamanosFijo.map((tamanos, index) => (
                              <TextosIconos>
                                {tamanos}
                                <br />
                              </TextosIconos>
                    ...
                    {ProgettoData.fijocircular && (
                      <Accordion allowToggle>
                        <AccordionItem border='0px'>
                          ...
                          <AccordionPanel>
                            {ProgettoData.tamanosCirculo.map(
                              (tamanos, index) => (
                                <TextosIconos>
                                  {tamanos}
                                  <br />
