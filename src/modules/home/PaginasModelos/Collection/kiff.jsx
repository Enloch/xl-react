      ...
      <DivisorBottom>
        <ContenidoBottom>
          <ContenedorSlider>
            <ContenedorInterior>
              <Slider>
                <CustomSliderMesas images={KiffData.imagenes} />
              </Slider>
            </ContenedorInterior>
          </ContenedorSlider>
          <ContenedorDatos>
            <ContenedorInterior>
              <TituloMesa>{KiffData.titulo}</TituloMesa>
              <SubtituloConPunto>
                <Punto>
                  <svg
                    width='12'
                ...
                <ContenedorTextoPunto>
                  <TextoPunto>{KiffData.subtitulo}</TextoPunto>
                </ContenedorTextoPunto>
              </SubtituloConPunto>
              <ParrafoSubtitulo>
                {KiffData.parrafo1}
                    ...
                    {KiffData.fijo && (
                      <Accordion allowToggle defaultIndex={[0]}>
                        <AccordionItem border='0px'>
                          ...
                          <AccordionPanel>
                            {KiffData.tamanosFijo.map((tamanos, index) => (
                    ...
                    {KiffData.fijocircular && (
                      <Accordion allowToggle>
                        <AccordionItem border='0px'>
                          ...
                          <AccordionPanel>
                            {KiffData.tamanosCirculo.map((tamanos, index) => (
                              <TextosIconos key={index}>
                                {tamanos}
                                <br />
                              </TextosIconos>
