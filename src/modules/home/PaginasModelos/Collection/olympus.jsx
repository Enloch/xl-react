      ...
      <DivisorBottom>
        <ContenidoBottom>
          <ContenedorSlider>
            <ContenedorInterior>
              <Slider>
                <CustomSliderMesas images={OlympusData.imagenes} />
              </Slider>
            </ContenedorInterior>
          </ContenedorSlider>
          <ContenedorDatos>
            <ContenedorInterior>
              <TituloMesa>{OlympusData.titulo}</TituloMesa>
              <SubtituloConPunto>
                <Punto>
                  <svg
                    width='12'
                ...
                <ContenedorTextoPunto>
                  <TextoPunto>{OlympusData.subtitulo}</TextoPunto>
                </ContenedorTextoPunto>
              </SubtituloConPunto>
              <ParrafoSubtitulo>
                {OlympusData.parrafo1}
                <br />
                {OlympusData.parrafo2}
                <br />
                {OlympusData.parrafo3}
                <br />
                {OlympusData.parrafo4}
              </ParrafoSubtitulo>
                    ...
                    {OlympusData.fijo && (
                      <Accordion allowToggle defaultIndex={[0]}>
                        <AccordionItem border='0px'>
                          ...
                          <AccordionPanel>
                            {OlympusData.tamanosFijo.map((tamanos, index) => (
                              <TextosIconos>
                                {tamanos}
                                <br />
                              </TextosIconos>
                    ...
                    {OlympusData.fijocircular && (
                      <Accordion allowToggle>
                        <AccordionItem border='0px'>
                          ...
                          <AccordionPanel>
                            {OlympusData.tamanosCirculo.map(
                              (tamanos, index) => (
                                <TextosIconos>
                                  {tamanos}
                                  <br />
