      ...
      <DivisorBottom>
        <ContenidoBottom>
          <ContenedorSlider>
            <ContenedorInterior>
              <Slider>
                <CustomSliderMesas images={MarioData.imagenes} />
              </Slider>
            </ContenedorInterior>
          </ContenedorSlider>
          <ContenedorDatos>
            <ContenedorInterior>
              <TituloMesa>{MarioData.titulo}</TituloMesa>
              <SubtituloConPunto>
                <Punto>
                  <svg
                    width='12'
                ...
                <ContenedorTextoPunto>
                  <TextoPunto>{MarioData.subtitulo}</TextoPunto>
                </ContenedorTextoPunto>
              </SubtituloConPunto>
              <ParrafoSubtitulo>
                {MarioData.parrafo1}
                    ...
                    {MarioData.fijo && (
                      <Accordion allowToggle defaultIndex={[0]}>
                        <AccordionItem border='0px'>
                          ...
                          <AccordionPanel>
                            {MarioData.tamanosFijo.map((tamanos, index) => (
                              <TextosIconos>
                                {tamanos}
                                <br />
                              </TextosIconos>
                    ...
                    {MarioData.fijocircular && (
                      <Accordion allowToggle>
                        <AccordionItem border='0px'>
                          ...
                          <AccordionPanel>
                            {MarioData.tamanosCirculo.map((tamanos, index) => (
                              <TextosIconos>
                                {tamanos}
                                <br />
                              </TextosIconos>
