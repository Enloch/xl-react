      ...
      <DivisorBottom>
        <ContenidoBottom>
          <ContenedorSlider>
            <ContenedorInterior>
              <Slider>
                <CustomSliderMesas images={RobData.imagenes} />
              </Slider>
            </ContenedorInterior>
          </ContenedorSlider>
          <ContenedorDatos>
            <ContenedorInterior>
              <TituloMesa>{RobData.titulo}</TituloMesa>
              <SubtituloConPunto>
                <Punto>
                  <svg
                    width='12'
                ...
                <ContenedorTextoPunto>
                  <TextoPunto>{RobData.subtitulo}</TextoPunto>
                </ContenedorTextoPunto>
              </SubtituloConPunto>
              <ParrafoSubtitulo>
                {RobData.parrafo1}
                    ...
                    {RobData.fijo && (
                      <Accordion allowToggle>
                        <AccordionItem border='0px'>
                          ...
                          {renderAccordionPanel(RobData.tamanosFijo, 4)}
                        </AccordionItem>
                      </Accordion>
                    )}
                    {RobData.extensible && (
                      <Accordion allowToggle>
                        <AccordionItem border='0px'>
                          ...
                          {renderAccordionPanel(RobData.tamanosExtensibles, 6)}
                        </AccordionItem>
                      </Accordion>
                    )}
                    {RobData.fijocircular && (
                      <Accordion allowToggle>
                        <AccordionItem border='0px'>
                          <AccordionButton>
                            <Box flex='1' textAlign='left'>
                          ...
                          {renderAccordionPanel(RobData.tamanosCirculo, 4)}
                        </AccordionItem>
                      </Accordion>
                    )}
                    {RobData.extensiblecircular && (
                      <Accordion allowToggle>
                        <AccordionItem border='0px'>
                          <AccordionButton>
                            <Box flex='1' textAlign='left'>
                          ...
                          {renderAccordionPanel(RobData.tamanosCircularExt, 4)}
                        </AccordionItem>
                      </Accordion>
                    )}
                  </AccordionPanel>
