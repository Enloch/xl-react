...
import { ManhattanData } from "../data";
import {
  Accordion,
  AccordionItem,
  AccordionButton,
      ...
      <DivisorBottom>
        <ContenidoBottom>
          <ContenedorSlider>
            <ContenedorInterior>
              <Slider>
                <CustomSliderMesas images={ManhattanData.imagenes} />
              </Slider>
            </ContenedorInterior>
          </ContenedorSlider>
          <ContenedorDatos>
            <ContenedorInterior>
              <TituloMesa>{ManhattanData.titulo}</TituloMesa>
              <SubtituloConPunto>
                <Punto>
                  <svg
                    width='12'
                ...
                <ContenedorTextoPunto>
                  <TextoPunto>{ManhattanData.subtitulo}</TextoPunto>
                </ContenedorTextoPunto>
              </SubtituloConPunto>
              <ParrafoSubtitulo>
                {ManhattanData.parrafo1}
                <br />
                {ManhattanData.parrafo2}
                <br />
                {ManhattanData.parrafo3}
                <br />
                {ManhattanData.parrafo4}
              </ParrafoSubtitulo>
                    ...
                    {ManhattanData.fijo && (
                      <Accordion allowToggle>
                        <AccordionItem border='0px'>
                          ...
                          {renderAccordionPanel(ManhattanData.tamanosFijo, 4)}
                        </AccordionItem>
                      </Accordion>
                    )}
                    {ManhattanData.extensible && (
                      <Accordion allowToggle>
                        <AccordionItem border='0px'>
                          <AccordionButton>
                            <Box flex='1' textAlign='left'>
                          ...
                          {renderAccordionPanel(
                            ManhattanData.tamanosExtensibles,
                            6
                          )}
                        </AccordionItem>
                      </Accordion>
                    )}
                    {ManhattanData.fijocircular && (
                      <Accordion allowToggle>
                        <AccordionItem border='0px'>
                          <AccordionButton>
                            <Box flex='1' textAlign='left'>
                          ...
                          {renderAccordionPanel(
                            ManhattanData.tamanosCirculo,
                            4
                          )}
                        </AccordionItem>
                      </Accordion>
                    )}
                    {ManhattanData.extensiblecircular && (
                      <Accordion allowToggle>
                        <AccordionItem border='0px'>
                          <AccordionButton>
                            <Box flex='1' textAlign='left'>
                          ...
                          {renderAccordionPanel(
                            ManhattanData.tamanosCircularExt,
                            4
                          )}
                        </AccordionItem>
                      </Accordion>
